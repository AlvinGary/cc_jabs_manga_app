...
class ActionGenrePage extends StatefulWidget {
  const ActionGenrePage({Key? key}) : super(key: key);

  @override
  _ActionGenrePageState createState() => _ActionGenrePageState();
}
...
class _ActionGenrePageState extends State<ActionGenrePage> {
  ...
  Future<List<ListComic>> fetchListComic(offset) async {
    await MangadexService.getActionComic(offset).then((value) {
      if (value.isNotEmpty) {
        setState(() {
