...
class ComedyGenrePage extends StatefulWidget {
  const ComedyGenrePage({Key? key}) : super(key: key);

  @override
  _ComedyGenrePageState createState() => _ComedyGenrePageState();
}
...
class _ComedyGenrePageState extends State<ComedyGenrePage> {
  ...
  Future<List<ListComic>> fetchListComic(offset) async {
    await MangadexService.getComedyComic(offset).then((value) {
      if (value.isNotEmpty) {
        setState(() {
